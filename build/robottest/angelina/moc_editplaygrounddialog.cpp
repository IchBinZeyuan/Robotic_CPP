...
#include "../../../src/robottest/angelina/editplaygrounddialog.h"
...
struct qt_meta_stringdata_EditPlayGroundDialog_t {
    QByteArrayData data[6];
    char stringdata0[61];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_EditPlayGroundDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_EditPlayGroundDialog_t qt_meta_stringdata_EditPlayGroundDialog = {
    {
QT_MOC_LITERAL(0, 0, 20), // "EditPlayGroundDialog"
QT_MOC_LITERAL(1, 21, 6), // "accept"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 12), // "slotAChanged"
QT_MOC_LITERAL(4, 42, 5), // "value"
QT_MOC_LITERAL(5, 48, 12) // "slotBChanged"

    },
    "EditPlayGroundDialog\0accept\0\0slotAChanged\0"
    "value\0slotBChanged"
};
...
const QMetaObject EditPlayGroundDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EditPlayGroundDialog.data,
      qt_meta_data_EditPlayGroundDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *EditPlayGroundDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EditPlayGroundDialog.stringdata0))
