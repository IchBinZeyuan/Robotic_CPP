...
(cl:defmethod cl:initialize-instance :after ((m <signal_transfer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'signal_transfer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gruppe3-msg:<signal_transfer> is deprecated: use gruppe3-msg:signal_transfer instead.")))

(cl:ensure-generic-function 'detectionstart-val :lambda-list '(m))
(cl:defmethod detectionstart-val ((m <signal_transfer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gruppe3-msg:detectionstart-val is deprecated.  Use gruppe3-msg:detectionstart instead.")
  (detectionstart m))

(cl:ensure-generic-function 'gamestart-val :lambda-list '(m))
(cl:defmethod gamestart-val ((m <signal_transfer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gruppe3-msg:gamestart-val is deprecated.  Use gruppe3-msg:gamestart instead.")
  (gamestart m))

(cl:ensure-generic-function 'stop-val :lambda-list '(m))
(cl:defmethod stop-val ((m <signal_transfer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gruppe3-msg:stop-val is deprecated.  Use gruppe3-msg:stop instead.")
  (stop m))

(cl:ensure-generic-function 'true_a-val :lambda-list '(m))
(cl:defmethod true_a-val ((m <signal_transfer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gruppe3-msg:true_a-val is deprecated.  Use gruppe3-msg:true_a instead.")
  (true_a m))

(cl:ensure-generic-function 'true_b-val :lambda-list '(m))
(cl:defmethod true_b-val ((m <signal_transfer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gruppe3-msg:true_b-val is deprecated.  Use gruppe3-msg:true_b instead.")
  (true_b m))

(cl:ensure-generic-function 'T_color-val :lambda-list '(m))
(cl:defmethod T_color-val ((m <signal_transfer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gruppe3-msg:T_color-val is deprecated.  Use gruppe3-msg:T_color instead.")
  (T_color m))
