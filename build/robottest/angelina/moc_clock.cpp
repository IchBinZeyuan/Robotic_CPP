...
#include "../../../src/robottest/angelina/clock.h"
...
QT_MOC_LITERAL(1, 6, 12), // "slotIncrease"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "Clock\0slotIncrease\0"
};
...
const QMetaObject Clock::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Clock.data,
...
void *Clock::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QSingleton<Clock>"))
        return static_cast< QSingleton<Clock>*>(const_cast< Clock*>(this));
