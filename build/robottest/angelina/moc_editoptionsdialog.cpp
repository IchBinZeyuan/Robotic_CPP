...
#include "../../../src/robottest/angelina/editoptionsdialog.h"
...
struct qt_meta_stringdata_EditOptionsDialog_t {
    QByteArrayData data[3];
    char stringdata0[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_EditOptionsDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_EditOptionsDialog_t qt_meta_stringdata_EditOptionsDialog = {
    {
QT_MOC_LITERAL(0, 0, 17), // "EditOptionsDialog"
QT_MOC_LITERAL(1, 18, 6), // "accept"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "EditOptionsDialog\0accept\0"
};
...
const QMetaObject EditOptionsDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EditOptionsDialog.data,
      qt_meta_data_EditOptionsDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *EditOptionsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EditOptionsDialog.stringdata0))
