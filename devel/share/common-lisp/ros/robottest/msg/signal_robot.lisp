...
(cl:defmethod cl:initialize-instance :after ((m <signal_robot>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'signal_robot)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robottest-msg:<signal_robot> is deprecated: use robottest-msg:signal_robot instead.")))

(cl:ensure-generic-function 'abratio-val :lambda-list '(m))
(cl:defmethod abratio-val ((m <signal_robot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robottest-msg:abratio-val is deprecated.  Use robottest-msg:abratio instead.")
  (abratio m))

(cl:ensure-generic-function 'detectcolor-val :lambda-list '(m))
(cl:defmethod detectcolor-val ((m <signal_robot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robottest-msg:detectcolor-val is deprecated.  Use robottest-msg:detectcolor instead.")
  (detectcolor m))

(cl:ensure-generic-function 'detect_done-val :lambda-list '(m))
(cl:defmethod detect_done-val ((m <signal_robot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robottest-msg:detect_done-val is deprecated.  Use robottest-msg:detect_done instead.")
  (detect_done m))

(cl:ensure-generic-function 'reportgoal-val :lambda-list '(m))
(cl:defmethod reportgoal-val ((m <signal_robot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robottest-msg:reportgoal-val is deprecated.  Use robottest-msg:reportgoal instead.")
  (reportgoal m))

(cl:ensure-generic-function 'odometrie_1-val :lambda-list '(m))
(cl:defmethod odometrie_1-val ((m <signal_robot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robottest-msg:odometrie_1-val is deprecated.  Use robottest-msg:odometrie_1 instead.")
  (odometrie_1 m))

(cl:ensure-generic-function 'odometrie_2-val :lambda-list '(m))
(cl:defmethod odometrie_2-val ((m <signal_robot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robottest-msg:odometrie_2-val is deprecated.  Use robottest-msg:odometrie_2 instead.")
  (odometrie_2 m))
